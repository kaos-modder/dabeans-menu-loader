...
(function (Il2Cpp) {
    ...
    Il2Cpp.exports = {
        get alloc() {
            return r("uHCFgKlerCa", "pointer", ["size_t"]);
        },
        get arrayGetLength() {
            return r("yRFdIhgzyqs", "uint32", ["pointer"]);
        },
        get arrayNew() {
            return r("HoxkGJVQjNq", "pointer", ["pointer", "uint32"]);
        },
        get assemblyGetImage() {
            return r("diqzc_lwpjq", "pointer", ["pointer"]);
        },
        get classForEach() {
            return r("KzAKeOSyPht", "void", ["pointer", "pointer"]);
        },
        get classFromName() {
            return r("ThlwdAonO_F", "pointer", ["pointer", "pointer", "pointer"]);
        },
        get classFromObject() {
            return r("MmtxrpWbgBp", "pointer", ["pointer"]);
        },
        get classGetArrayClass() {
            return r("WfVYDjGcqXq", "pointer", ["pointer", "uint32"]);
        },
        get classGetArrayElementSize() {
            return r("ZmZkcoJFsMg", "int", ["pointer"]);
        },
        get classGetAssemblyName() {
            return r("xlQDjuigzlc", "pointer", ["pointer"]);
        },
        get classGetBaseType() {
            return r("UkYuwpPDbjp", "pointer", ["pointer"]);
        },
        get classGetDeclaringType() {
            return r("bbLERHZymBq", "pointer", ["pointer"]);
        },
        get classGetElementClass() {
            return r("ndzLtnFFigj", "pointer", ["pointer"]);
        },
        get classGetFieldFromName() {
            return r("wzlKWctMZMP", "pointer", ["pointer", "pointer"]);
        },
        get classGetFields() {
            return r("L_rSKqYVcmP", "pointer", ["pointer", "pointer"]);
        },
        get classGetFlags() {
            return r("LzgkrjeRiGU", "int", ["pointer"]);
        },
        get classGetImage() {
            return r("fCeRvWOaGbe", "pointer", ["pointer"]);
        },
        get classGetInstanceSize() {
            return r("WwVxXrVqEbs", "int32", ["pointer"]);
        },
        get classGetInterfaces() {
            return r("JcBeczAFiEq", "pointer", ["pointer", "pointer"]);
        },
        get classGetMethodFromName() {
            return r("mrtTU_RDDVY", "pointer", ["pointer", "pointer", "int"]);
        },
        get classGetMethods() {
            return r("xnUYijJuNQm", "pointer", ["pointer", "pointer"]);
        },
        get classGetName() {
            return r("rNPwnoakdOi", "pointer", ["pointer"]);
        },
        get classGetNamespace() {
            return r("vUPSYEQzzXz", "pointer", ["pointer"]);
        },
        get classGetNestedClasses() {
            return r("HbrTXpcsQdp", "pointer", ["pointer", "pointer"]);
        },
        get classGetParent() {
            return r("UfexoRfySYB", "pointer", ["pointer"]);
        },
        get classGetStaticFieldData() {
            return r("xkkiaPdMlTU", "pointer", ["pointer"]);
        },
        get classGetValueTypeSize() {
            return r("wAENnFTZocz", "int32", ["pointer", "pointer"]);
        },
        get classGetType() {
            return r("cUGBomDAJwB", "pointer", ["pointer"]);
        },
        get classHasReferences() {
            return r("TzdaonpHFEL", "bool", ["pointer"]);
        },
        get classInitialize() {
            return r("PGSpaUDoaRN", "void", ["pointer"]);
        },
        get classIsAbstract() {
            return r("gYHCsQagZOo", "bool", ["pointer"]);
        },
        get classIsAssignableFrom() {
            return r("YSWTzPXiNuf", "bool", ["pointer", "pointer"]);
        },
        get classIsBlittable() {
            return r("UMudoVByqDB", "bool", ["pointer"]);
        },
        get classIsEnum() {
            return r("LKUzoutQcvh", "bool", ["pointer"]);
        },
        get classIsGeneric() {
            return r("HqUnjiNacQF", "bool", ["pointer"]);
        },
        get classIsInflated() {
            return r("bLBLyz__cUl", "bool", ["pointer"]);
        },
        get classIsInterface() {
            return r("OVhzGbPTMln", "bool", ["pointer"]);
        },
        get classIsSubclassOf() {
            return r("PvkXYsMvtVg", "bool", ["pointer", "pointer", "bool"]);
        },
        get classIsValueType() {
            return r("CkRwBcvKXTt", "bool", ["pointer"]);
        },
        get domainGetAssemblyFromName() {
            return r("tLNEnOdExYz", "pointer", ["pointer", "pointer"]);
        },
        get domainGet() {
            return r("KFZkHVjFbCn", "pointer", []);
        },
        get domainGetAssemblies() {
            return r("KdiBlgWJPKH", "pointer", ["pointer", "pointer"]);
        },
        get fieldGetClass() {
            return r("JrTsmLMgtYw", "pointer", ["pointer"]);
        },
        get fieldGetFlags() {
            return r("OpIMORImenk", "int", ["pointer"]);
        },
        get fieldGetName() {
            return r("_DkvYgNiXiV", "pointer", ["pointer"]);
        },
        get fieldGetOffset() {
            return r("gNxWMcBgVxu", "int32", ["pointer"]);
        },
        get fieldGetStaticValue() {
            return r("eUrcbJwe_Bc", "void", ["pointer", "pointer"]);
        },
        get fieldGetType() {
            return r("Ikdb_OIJtVE", "pointer", ["pointer"]);
        },
        get fieldSetStaticValue() {
            return r("ggexGZmyofD", "void", ["pointer", "pointer"]);
        },
        get free() {
            return r("HxfqvPwsBuF", "void", ["pointer"]);
        },
        get gcCollect() {
            return r("RkpLONskKrd", "void", ["int"]);
        },
        get gcCollectALittle() {
            return r("_xqYrctfDFZ", "void", []);
        },
        get gcDisable() {
            return r("wPStgiWplIz", "void", []);
        },
        get gcEnable() {
            return r("QfFObsocF_e", "void", []);
        },
        get gcGetHeapSize() {
            return r("CfaMbdZqSxX", "int64", []);
        },
        get gcGetMaxTimeSlice() {
            return r("fbcFzFViCNJ", "int64", []);
        },
        get gcGetUsedSize() {
            return r("gCTGQJUyOFs", "int64", []);
        },
        get gcHandleGetTarget() {
            return r("OsrXvLSzyjs", "pointer", ["uint32"]);
        },
        get gcHandleFree() {
            return r("siDqGKLoczK", "void", ["uint32"]);
        },
        get gcHandleNew() {
            return r("qkRPa_Audif", "uint32", ["pointer", "bool"]);
        },
        get gcHandleNewWeakRef() {
            return r("bSGqObtyKrw", "uint32", ["pointer", "bool"]);
        },
        get gcIsDisabled() {
            return r("zwucqaykNNB", "bool", []);
        },
        get gcIsIncremental() {
            return r("RmmwTHGMEed", "bool", []);
        },
        get gcSetMaxTimeSlice() {
            return r("ckNAYoTjMxx", "void", ["int64"]);
        },
        get gcStartIncrementalCollection() {
            return r("ISIXaSsvTFN", "void", []);
        },
        get gcStartWorld() {
            return r("cacTSvdJVWg", "void", []);
        },
        get gcStopWorld() {
            return r("QpRDUbAphJD", "void", []);
        },
        get getCorlib() {
            return r("KHsCqaFb_Kc", "pointer", []);
        },
        get imageGetAssembly() {
            return r("qCMbNIeAVZT", "pointer", ["pointer"]);
        },
        get imageGetClass() {
            return r("OEOowyBBZOU", "pointer", ["pointer", "uint"]);
        },
        get imageGetClassCount() {
            return r("VyvQjZasOPW", "uint32", ["pointer"]);
        },
        get imageGetName() {
            return r("dZEBiJPVExn", "pointer", ["pointer"]);
        },
        get initialize() {
            return r("rMNVufdfVZu", "void", ["pointer"]);
        },
        get livenessAllocateStruct() {
            return r("UdMwNeHFEwk", "pointer", ["pointer", "int", "pointer", "pointer", "pointer"]);
        },
        ...
        get livenessCalculationFromStatics() {
            return r("riHRAjeXSJM", "void", ["pointer"]);
        },
        get livenessFinalize() {
            return r("NSMBjkbGqHY", "void", ["pointer"]);
        },
        get livenessFreeStruct() {
            return r("JmYO_ZNWHOM", "void", ["pointer"]);
        },
        get memorySnapshotCapture() {
            return r("zsRevDOJJST", "pointer", []);
        },
        get memorySnapshotFree() {
            return r("dxUxyDvWlwJ", "void", ["pointer"]);
        },
        ...
        get methodGetClass() {
            return r("zRoNHGzysqk", "pointer", ["pointer"]);
        },
        get methodGetFlags() {
            return r("LAHgRPhhKaV", "uint32", ["pointer", "pointer"]);
        },
        get methodGetName() {
            return r("zGdwd__onfl", "pointer", ["pointer"]);
        },
        get methodGetObject() {
            return r("kKFatZXMYYJ", "pointer", ["pointer", "pointer"]);
        },
        get methodGetParameterCount() {
            return r("PbsOWItWGkH", "uint8", ["pointer"]);
        },
        get methodGetParameterName() {
            return r("DhUZkRhYPrG", "pointer", ["pointer", "uint32"]);
        },
        get methodGetParameters() {
            return r("il2cpp_method_get_parameters", "pointer", ["pointer", "pointer"]);
        },
        get methodGetParameterType() {
            return r("uoFCEysLjLH", "pointer", ["pointer", "uint32"]);
        },
        get methodGetReturnType() {
            return r("WDeRxAaLeDS", "pointer", ["pointer"]);
        },
        get methodIsGeneric() {
            return r("_nzgaYoUicW", "bool", ["pointer"]);
        },
        get methodIsInflated() {
            return r("cMOWWuyIJKs", "bool", ["pointer"]);
        },
        get methodIsInstance() {
            return r("GCvKJsnUuBI", "bool", ["pointer"]);
        },
        get monitorEnter() {
            return r("RmirxCGaZWh", "void", ["pointer"]);
        },
        get monitorExit() {
            return r("gLIJinKQWjt", "void", ["pointer"]);
        },
        get monitorPulse() {
            return r("WJRijpcuKYe", "void", ["pointer"]);
        },
        get monitorPulseAll() {
            return r("zsdKGECWAgK", "void", ["pointer"]);
        },
        get monitorTryEnter() {
            return r("pKnEszWaHwX", "bool", ["pointer", "uint32"]);
        },
        get monitorTryWait() {
            return r("_WNpwMEQadc", "bool", ["pointer", "uint32"]);
        },
        get monitorWait() {
            return r("jdeioGZ_Gzo", "void", ["pointer"]);
        },
        get objectGetClass() {
            return r("swBuvBkMphH", "pointer", ["pointer"]);
        },
        get objectGetVirtualMethod() {
            return r("lkpbaDROIWp", "pointer", ["pointer", "pointer"]);
        },
        get objectInitialize() {
            return r("FwhpgaIgBtx", "void", ["pointer", "pointer"]);
        },
        get objectNew() {
            return r("LUIRLXAAlhY", "pointer", ["pointer"]);
        },
        get objectGetSize() {
            return r("bDriTVdhhhu", "uint32", ["pointer"]);
        },
        get objectUnbox() {
            return r("mGnfBuiLFdt", "pointer", ["pointer"]);
        },
        get resolveInternalCall() {
            return r("hajlwDwkIa_", "pointer", ["pointer"]);
        },
        get stringGetChars() {
            return r("fyCwwgNDkpA", "pointer", ["pointer"]);
        },
        get stringGetLength() {
            return r("MSsxSgvyulR", "int32", ["pointer"]);
        },
        get stringNew() {
            return r("pugqdQrOFqz", "pointer", ["pointer"]);
        },
        get valueTypeBox() {
            return r("HmtaLslkfiT", "pointer", ["pointer", "pointer"]);
        },
        get threadAttach() {
            return r("ZgVBVGLrzYK", "pointer", ["pointer"]);
        },
        get threadDetach() {
            return r("ikgQolMyYJa", "void", ["pointer"]);
        },
        get threadGetAttachedThreads() {
            return r("il2cpp_thread_get_all_attached_threads", "pointer", ["pointer"]);
        },
        get threadGetCurrent() {
            return r("RGfpHTIyPgf", "pointer", []);
        },
        get threadIsVm() {
            return r("rtRidvTAfzq", "bool", ["pointer"]);
        },
        get typeEquals() {
            return r("CKx_YSgZNfA", "bool", ["pointer", "pointer"]);
        },
        get typeGetClass() {
            return r("kRLGIFxBLeq", "pointer", ["pointer"]);
        },
        get typeGetName() {
            return r("CUeYHAUujlZ", "pointer", ["pointer"]);
        },
        get typeGetObject() {
            return r("hQXtbNkRCtH", "pointer", ["pointer"]);
        },
        get typeGetTypeEnum() {
            return r("xzQ_oFfVJfM", "int", ["pointer"]);
        }
    };
