...
(function (Il2Cpp) {
    ...
    Il2Cpp.exports = {
        get alloc() {
            return r("coRizmWrbwk", "pointer", ["size_t"]);
        },
        get arrayGetLength() {
            return r("GIlFPpcxGwk", "uint32", ["pointer"]);
        },
        get arrayNew() {
            return r("AcRcznZVexk", "pointer", ["pointer", "uint32"]);
        },
        get assemblyGetImage() {
            return r("ZWABzAxkJbF", "pointer", ["pointer"]);
        },
        get classForEach() {
            return r("yfRhDLMLQwB", "void", ["pointer", "pointer"]);
        },
        get classFromName() {
            return r("WwDoOXXPFW_", "pointer", ["pointer", "pointer", "pointer"]);
        },
        get classFromObject() {
            return r("KyAt_FFupmj", "pointer", ["pointer"]);
        },
        get classGetArrayClass() {
            return r("gYECzreeHVW", "pointer", ["pointer", "uint32"]);
        },
        get classGetArrayElementSize() {
            return r("ubYLAFwxJgn", "int", ["pointer"]);
        },
        get classGetAssemblyName() {
            return r("RoFTezSNJHE", "pointer", ["pointer"]);
        },
        get classGetBaseType() {
            return r("fJycnydtrx_", "pointer", ["pointer"]);
        },
        get classGetDeclaringType() {
            return r("GrllW_rKvyn", "pointer", ["pointer"]);
        },
        get classGetElementClass() {
            return r("tvZKMixONaH", "pointer", ["pointer"]);
        },
        get classGetFieldFromName() {
            return r("DJVSWkzmqVk", "pointer", ["pointer", "pointer"]);
        },
        get classGetFields() {
            return r("cDdzmhLcUGh", "pointer", ["pointer", "pointer"]);
        },
        get classGetFlags() {
            return r("abYFLlRWLkE", "int", ["pointer"]);
        },
        get classGetImage() {
            return r("rFgfoqWEMNk", "pointer", ["pointer"]);
        },
        get classGetInstanceSize() {
            return r("HMRFhzwTENM", "int32", ["pointer"]);
        },
        get classGetInterfaces() {
            return r("lmMmfKnnqPR", "pointer", ["pointer", "pointer"]);
        },
        get classGetMethodFromName() {
            return r("mvocquBFZOU", "pointer", ["pointer", "pointer", "int"]);
        },
        get classGetMethods() {
            return r("nJTkeLaKwcQ", "pointer", ["pointer", "pointer"]);
        },
        get classGetName() {
            return r("qvumZksOZ_y", "pointer", ["pointer"]);
        },
        get classGetNamespace() {
            return r("JDxrr_lJCPD", "pointer", ["pointer"]);
        },
        get classGetNestedClasses() {
            return r("CVpRLvdMbSB", "pointer", ["pointer", "pointer"]);
        },
        get classGetParent() {
            return r("sCekjHhEoxA", "pointer", ["pointer"]);
        },
        get classGetStaticFieldData() {
            return r("gNkKZMPJlbe", "pointer", ["pointer"]);
        },
        get classGetValueTypeSize() {
            return r("elFhHdHhxmG", "int32", ["pointer", "pointer"]);
        },
        get classGetType() {
            return r("ZwSelDIHpRI", "pointer", ["pointer"]);
        },
        get classHasReferences() {
            return r("tQdxjl_BIlQ", "bool", ["pointer"]);
        },
        get classInitialize() {
            return r("zRDyVRyvttp", "void", ["pointer"]);
        },
        get classIsAbstract() {
            return r("KzUfxvpjPGU", "bool", ["pointer"]);
        },
        get classIsAssignableFrom() {
            return r("MsVijdkwKgn", "bool", ["pointer", "pointer"]);
        },
        get classIsBlittable() {
            return r("tuvLbWVhFGp", "bool", ["pointer"]);
        },
        get classIsEnum() {
            return r("UhTvDE_tygr", "bool", ["pointer"]);
        },
        get classIsGeneric() {
            return r("WcpbunNeAOp", "bool", ["pointer"]);
        },
        get classIsInflated() {
            return r("jbCAykarDAQ", "bool", ["pointer"]);
        },
        get classIsInterface() {
            return r("aBzTQMrlrkG", "bool", ["pointer"]);
        },
        get classIsSubclassOf() {
            return r("GHPIowILUn_", "bool", ["pointer", "pointer", "bool"]);
        },
        get classIsValueType() {
            return r("kbwbUPoNPhS", "bool", ["pointer"]);
        },
        get domainGetAssemblyFromName() {
            return r("OjWNUKNSOZh", "pointer", ["pointer", "pointer"]);
        },
        get domainGet() {
            return r("oYQKjhDCIkJ", "pointer", []);
        },
        get domainGetAssemblies() {
            return r("LXctKGJHuFR", "pointer", ["pointer", "pointer"]);
        },
        get fieldGetClass() {
            return r("ktLQRzHTEXa", "pointer", ["pointer"]);
        },
        get fieldGetFlags() {
            return r("HqROENP_WXg", "int", ["pointer"]);
        },
        get fieldGetName() {
            return r("GlxrvACnfCP", "pointer", ["pointer"]);
        },
        get fieldGetOffset() {
            return r("HjnCKtikOOD", "int32", ["pointer"]);
        },
        get fieldGetStaticValue() {
            return r("FxLLEZdqzEx", "void", ["pointer", "pointer"]);
        },
        get fieldGetType() {
            return r("I_WPqLadKbj", "pointer", ["pointer"]);
        },
        get fieldSetStaticValue() {
            return r("IcfTAtEWPhd", "void", ["pointer", "pointer"]);
        },
        get free() {
            return r("asZgDWFxduo", "void", ["pointer"]);
        },
        get gcCollect() {
            return r("gfgnDAwqtkw", "void", ["int"]);
        },
        get gcCollectALittle() {
            return r("YYMTaHEAjpO", "void", []);
        },
        get gcDisable() {
            return r("nlUmHIVDTwY", "void", []);
        },
        get gcEnable() {
            return r("JFRbqxCDNCA", "void", []);
        },
        get gcGetHeapSize() {
            return r("kdsWX_rPzbU", "int64", []);
        },
        get gcGetMaxTimeSlice() {
            return r("oWzinrXnikA", "int64", []);
        },
        get gcGetUsedSize() {
            return r("dtPILqIBKT_", "int64", []);
        },
        get gcHandleGetTarget() {
            return r("kyUCPYRyTWE", "pointer", ["uint32"]);
        },
        get gcHandleFree() {
            return r("bWIOHVNMpOo", "void", ["uint32"]);
        },
        get gcHandleNew() {
            return r("kEvnlZUYioc", "uint32", ["pointer", "bool"]);
        },
        get gcHandleNewWeakRef() {
            return r("vM_JcqtAFON", "uint32", ["pointer", "bool"]);
        },
        get gcIsDisabled() {
            return r("isZpBnRNqm_", "bool", []);
        },
        get gcIsIncremental() {
            return r("UqASgNISETd", "bool", []);
        },
        get gcSetMaxTimeSlice() {
            return r("SWOH_XJBCda", "void", ["int64"]);
        },
        get gcStartIncrementalCollection() {
            return r("lojkjsjaSTg", "void", []);
        },
        get gcStartWorld() {
            return r("aKTQzdjxrgo", "void", []);
        },
        get gcStopWorld() {
            return r("IKe_WDGLXwB", "void", []);
        },
        get getCorlib() {
            return r("wTAKDwxlPrq", "pointer", []);
        },
        get imageGetAssembly() {
            return r("mYMKBfykBZA", "pointer", ["pointer"]);
        },
        get imageGetClass() {
            return r("VRzbJEqQlbu", "pointer", ["pointer", "uint"]);
        },
        get imageGetClassCount() {
            return r("TJqzKBWoAlG", "uint32", ["pointer"]);
        },
        get imageGetName() {
            return r("MjZDbXimaDI", "pointer", ["pointer"]);
        },
        get initialize() {
            return r("G_SwUIZnYMx", "void", ["pointer"]);
        },
        get livenessAllocateStruct() {
            return r("N_VDVhTWMhX", "pointer", ["pointer", "int", "pointer", "pointer", "pointer"]);
        },
        ...
        get livenessCalculationFromStatics() {
            return r("XcKFsDgQztM", "void", ["pointer"]);
        },
        get livenessFinalize() {
            return r("mDVEaECXlKA", "void", ["pointer"]);
        },
        get livenessFreeStruct() {
            return r("fmrnkDMhycx", "void", ["pointer"]);
        },
        get memorySnapshotCapture() {
            return r("iG_KLbExNGm", "pointer", []);
        },
        get memorySnapshotFree() {
            return r("XcIIRlJwmRt", "void", ["pointer"]);
        },
        ...
        get methodGetClass() {
            return r("kCnIWfqcnCe", "pointer", ["pointer"]);
        },
        get methodGetFlags() {
            return r("auLEYIRgv_T", "uint32", ["pointer", "pointer"]);
        },
        get methodGetName() {
            return r("nRvfOQRnxGX", "pointer", ["pointer"]);
        },
        get methodGetObject() {
            return r("_XxLuZimMPu", "pointer", ["pointer", "pointer"]);
        },
        get methodGetParameterCount() {
            return r("pgJMBBZSFVS", "uint8", ["pointer"]);
        },
        get methodGetParameterName() {
            return r("ErJoMaynTVu", "pointer", ["pointer", "uint32"]);
        },
        get methodGetParameters() {
            return r("il2cpp_method_get_parameters", "pointer", ["pointer", "pointer"]);
        },
        get methodGetParameterType() {
            return r("yRqOzLOoORT", "pointer", ["pointer", "uint32"]);
        },
        get methodGetReturnType() {
            return r("C_PmznrDejv", "pointer", ["pointer"]);
        },
        get methodIsGeneric() {
            return r("YYGgLPgveFo", "bool", ["pointer"]);
        },
        get methodIsInflated() {
            return r("yshgdRsUj_d", "bool", ["pointer"]);
        },
        get methodIsInstance() {
            return r("xZRdezwyovX", "bool", ["pointer"]);
        },
        get monitorEnter() {
            return r("lPPShNPoriK", "void", ["pointer"]);
        },
        get monitorExit() {
            return r("rqYIcOIzNAY", "void", ["pointer"]);
        },
        get monitorPulse() {
            return r("ZiEzxhDmqjf", "void", ["pointer"]);
        },
        get monitorPulseAll() {
            return r("ADbyybtpdWq", "void", ["pointer"]);
        },
        get monitorTryEnter() {
            return r("YJXiGBlMdL_", "bool", ["pointer", "uint32"]);
        },
        get monitorTryWait() {
            return r("BWcyyebViDi", "bool", ["pointer", "uint32"]);
        },
        get monitorWait() {
            return r("xEeEtuCmEZY", "void", ["pointer"]);
        },
        get objectGetClass() {
            return r("qOqU_AuUZyC", "pointer", ["pointer"]);
        },
        get objectGetVirtualMethod() {
            return r("ObywcxDqczo", "pointer", ["pointer", "pointer"]);
        },
        get objectInitialize() {
            return r("_lJBmtclBLf", "void", ["pointer", "pointer"]);
        },
        get objectNew() {
            return r("JjtlkvxPOmD", "pointer", ["pointer"]);
        },
        get objectGetSize() {
            return r("HZeuNiHMoUx", "uint32", ["pointer"]);
        },
        get objectUnbox() {
            return r("UovD_lbaVuJ", "pointer", ["pointer"]);
        },
        get resolveInternalCall() {
            return r("sKoRYPtlJmq", "pointer", ["pointer"]);
        },
        get stringGetChars() {
            return r("SDEXXacIyDE", "pointer", ["pointer"]);
        },
        get stringGetLength() {
            return r("dejBcAuTVOk", "int32", ["pointer"]);
        },
        get stringNew() {
            return r("XjJGTgAPLSO", "pointer", ["pointer"]);
        },
        get valueTypeBox() {
            return r("zpCQtYWI_ft", "pointer", ["pointer", "pointer"]);
        },
        get threadAttach() {
            return r("BqEoKGbomZx", "pointer", ["pointer"]);
        },
        get threadDetach() {
            return r("yMVPKWiQhIA", "void", ["pointer"]);
        },
        get threadGetAttachedThreads() {
            return r("il2cpp_thread_get_all_attached_threads", "pointer", ["pointer"]);
        },
        get threadGetCurrent() {
            return r("qopsiMxhplr", "pointer", []);
        },
        get threadIsVm() {
            return r("lRMbeRYUbin", "bool", ["pointer"]);
        },
        get typeEquals() {
            return r("feMTDcfoKUi", "bool", ["pointer", "pointer"]);
        },
        get typeGetClass() {
            return r("DqQibdMbCrZ", "pointer", ["pointer"]);
        },
        get typeGetName() {
            return r("evzrBJPHHLc", "pointer", ["pointer"]);
        },
        get typeGetObject() {
            return r("LJLRWYCeAcH", "pointer", ["pointer"]);
        },
        get typeGetTypeEnum() {
            return r("PHmjabhVoCc", "int", ["pointer"]);
        }
    };
